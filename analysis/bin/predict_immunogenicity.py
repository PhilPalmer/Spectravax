...
class Prediction():
    ...
    def validate(self, options, peptides):
        ...
        if custom_mask:
            ...
            if not all([len(sequence) >= max_length for sequence in peptides]):
        ...
        return peptides, custom_mask, allele
    ...
    def predict(self, cleaned_data):
        ...
        peptides, custom_mask, allele = cleaned_data
...
""")
    ...
    def main(self):
        ...
        self.predict(self.validate(options, peptides))

    def main2(self):
        parser = argparse.ArgumentParser(prog=__file__, usage="usage: %(prog)s [options] input")
        ...
        parser.add_argument('-m', '--custom_mask',
                            help="Specify comma separated numbers for additional anchor positions (default: 1st, 2nd, and C-terminus amino acids).")
        ...
        parser.add_argument('-l', '--allele_list',
                            action='store_true',
                            default=False,
                            help="List all available alleles.")
        ...
        # print(options.custom_mask)
        self.predict(self.validate(options, [new_args]))
